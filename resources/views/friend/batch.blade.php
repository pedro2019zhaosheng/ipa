...
@section('content')
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            ...
            <input type="hidden" name="robot_type" value="5">
            ...
            <div class="box box-primary">
                <div class="box-body">
                    <div class="form-group ">
                        {{ Form::textarea('keyword', $wxdata->keyword?$wxdata->keyword:'粘贴微信号或手机号，多个号码以英文逗号“,”或“|”隔开，两种方式只能选其一。', ['class'=>'form-control', 'row'=>'6']) }}
                    </div>
            ...
            <div class="box box-primary">
                <div class="box-body">
                    <div class="form-group ">
                     加好友验证信息   {{ Form::textarea('verify', $wxdata->verify?$wxdata->verify:'你好，我是', ['class'=>'form-control', 'row'=>'6']) }}
                    </div>
    ...
    <script type="text/javascript">
        function aa(){
            ...
            var url = '/friend/saveRobotId?robot_id='+check_val+'&save_type=5';
            $("#sampling").val(url);
            if(check_val==''){
                check_val = 0;
            }
