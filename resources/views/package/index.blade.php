        ...
        <div class="box box-primary">
            <div class="box-body">
                ...
                <div class="form-group col-sm-100">
                    ...
                    <span style="color: red">{!! Form::text('version', "{$domain}/ipa/?package_id=2" , ['id'=>'qr_code','placeholder'=>'http://test.daoyuancloud.com/udid?apple_id=3&package_id=2','class' => 'form-control']) !!}</span>
