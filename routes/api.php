...
Route::any('user/packageInfo','Api\UserController@packageInfo')->name('packageInfo');//包信息

Route::any('user/logout','Api\UserController@logout')->name('logout');//退出

Route::any('user/userInfo','Api\UserController@userInfo')->name('userInfo');//用户信息

Route::any('user/delPackage','Api\UserController@delPackage')->name('delPackage');//用户信息
